...
# Filter the data to keep only rows where 'Phylogeographic tree' is 'O2-saturation_ground'
filtered_data = data[data['Phylogeographic tree'] == 'O2-saturation_ground']

# Ensure that the columns in the CSV file match the distances you want to plot
...
positions = filtered_data['Position in MSA']  # Ensure this column contains the positions
...
axs[2].set_yticks([0.8, 0.9, 1.0, 1.1, 1.2, 1.3])
...
# Save the plot
plt.savefig('Figure8.png', format='png', dpi=300)
